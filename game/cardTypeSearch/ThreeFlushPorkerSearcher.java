...
public class ThreeFlushPorkerSearcher extends AbstractSearcher{
	public ThreeFlushPorkerSearcher(){
	...
	public int searchBiggerPorkerThanMax(List<Integer> playerHandPorker, int nMaxHandPattern, int nMajorFaceValue, List<Integer> sumbitPorkerList){
		...
		parameter.setCardTypeEnumValue(CardTypeEnum.CARD_TYPE_TWO_CONTINUE_THREE_PIECES_VALUE);
		parameter.setMajorFaceValue(nMajorFaceValue);
		parameter.setMajorHeartValueNum(majorHeartPieceNum.getToolValueByInt());
		parameter.setFlushContinueDiffNumber(2);
		parameter.setFlushSameFacePorkerNumber(3);
